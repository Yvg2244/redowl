  ...
  return (
    <div className="w-[100vw] h-auto tracking-wider  grid grid-cols-2">
      ...
      <section className="mt-[4rem] col-span-2 h-auto my-4 gap-10 px-[1rem] md:pl-[4rem] md:pr-[4rem] justify-center ">
        ...
        <div className="items-center grid gap-4 col-span-3 grid-cols-1 p-8">
      ...
      <h3 className="text-[20px]  font-bold">Download Our App</h3>
      <p> RedOwl SMS is a reliable & cost-effective solution with pre- defined & custom template facility</p>
      <div className="flex flex-col gap-4">
        <div className="w-[10rem]"><Image src={appleStore}/></div>
        <div className="w-[10rem]"><Image src={googleButton}/></div>
        <div className="w-[10rem]"><Image src={windowButton}/></div>
      </div>
      </section>
      <BottomNav />
    </div>
