...
const Mainpage = () => {
  return (
    <div className="w-[100vw] h-auto tracking-wider  grid grid-cols-2">
      <main className="flex mt-[5rem] relative col-span-2 h-[50vh] md:min-h-[80vh] items-center px-[1rem] md:pl-[4rem] md:pr-[4rem] justify-between">
      ...
      <section className="flex flex-wrap mt-[4rem] justify-around gap-[4rem] md:mt-[6rem] w-[100vw] px-[1rem] md:pl-[4rem] md:pr-[4rem]">
        ...
        <div className="flex flex-col p-2 shadow-xl shadow-black-500/50 w-[25rem] md:w-[20rem] justify-between rounded-lg items-center relative ">
          ...
          <h3 className="text-[20px] mt-[3.5rem] font-extrabold">Smart Gate</h3>
          <ul className="list-disc p-[2rem]  text-[14px] leading-7">
